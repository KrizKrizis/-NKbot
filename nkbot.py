...
# Создаём бота. Без group_id — бот будет использовать Callback API
...
# Этот обработчик ловит ЛЮБОЕ текстовое сообщение.
# После проверки его нужно удалить или закомментировать.
@bot.on.message()
